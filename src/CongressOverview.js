...
const CongressOverview = ({ title, race, currentSeats, demSeatsWon, repSeatsWon, indSeatsWon, totalSeats, demVotes, repVotes, candidates, year }) => {
  const projectedWinner = demSeatsWon > repSeatsWon ? "Democratic Party" : "Republican Party";
  const demTotalSeats = currentSeats.find(seat => seat.party === "Democratic").seats + demSeatsWon;
  const repTotalSeats = currentSeats.find(seat => seat.party === "Republican").seats + repSeatsWon;
  const indTotalSeats = currentSeats.find(seat => seat.party === "Independent").seats + indSeatsWon;
  ...
  return (
    <div style={styles.electionOverview}>
      ...
      <div style={styles.candidateInfo}>
        ...
        <div style={styles.candidate}>
          ...
          <div style={styles.textBox}>
            ...
            <h2>{demSeatsWon.toLocaleString()} Seats Won</h2>
            <h3>{demVotes.toLocaleString()} Total Votes</h3>
        ...
        <div style={styles.candidate}>
          ...
          <div style={styles.textBox}>
            ...
            <h2>{repSeatsWon.toLocaleString()} Seats Won</h2>
            <h3>{repVotes.toLocaleString()} Total Votes</h3>
      ...
      <div style={styles.progressLabels}>
        <span>{demTotalSeats.toLocaleString()} Seats</span>
        <span>{midpoint} Seats</span>
        <span>{repTotalSeats.toLocaleString()} Seats</span>
      </div>
