...
const Map = ({ stateResults, race, candidates, year }) => {
    ...
    const isHouseRace = race === "House";
    const mapGeoJson = isHouseRace ? districtsGeoJson : countryUrl;

    return (
        <div style={styles.map} onMouseMove={handleMouseMove}>
            <ComposableMap projection="geoAlbersUsa" width={isHouseRace ? 5000 : 800} height={isHouseRace ? 2500 : 500}>
